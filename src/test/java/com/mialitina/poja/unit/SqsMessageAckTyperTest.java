package com.mialitina.poja.unit;
...
import com.mialitina.poja.endpoint.event.EventConsumer;
...
public class SqsMessageAckTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent("com.mialitina.poja.endpoint.event.gen.UuidCreated", payload);
